			...
			for (var col = 1; col <= numCols; col++) {
				...
				(function(row, col, seatNumber) {
					seatElement.addEventListener('click', function() {
						// 이미 선택된 좌석인지 확인
						var isSeatSelected = selectedSeats.some(function(
								selectedSeat) {
						...
						if (isSeatSelected) {
							// 이미 선택된 좌석을 배열에서 제거
							selectedSeats = selectedSeats.filter(function(
									selectedSeat) {
								return selectedSeat.seat_id !== seatNumber;
							});
						} else {
...
<div class="wrap_reserve">
	...
	<div id="PersonSeatHeader" class="section_step_tit">
		<ul>
			<li class="step01 prev"><a href="/ticketing/schedule">
	</div>
	</a>
	</li>
					...
					<div class="count_people">
						...
						<ul>
							...
							<li id="person_20" data-code="20" data-peple="청소년" data-count="0"
								value="10000"><strong class="tit">청소년</strong> <span
								class="bx_num">
			...
			<div id="PersonSeatSummery">
				<div class="select_seat_result">
					...
					<form id="paymentForm" onsubmit="return validateForm()">
						<div class="group_rgt">
							<a href="/ticketing/orderSettlement" class="btn_col1"
								id="link_rpay">결제하기</a>
						</div>
					</form>
				</div>
